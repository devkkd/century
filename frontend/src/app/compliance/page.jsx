  ...
  },
  {
    ...
    content: [
      ...
      <React.Fragment key="contact-details">
        Email: aqib@centurypapers.com
        <br />
        sales@centurypapers.com
        <br />
        Phone / WhatsApp: +91 96605 05555
        <br />
        Response time: Most documentation requests are fulfilled within two
        working days.
      </React.Fragment>,
    ],
  },
    ...
    <>
      <main className="min-h-screen pt-12 px-6 lg:px-12 max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col items-center text-center w-full max-w-5xl mx-auto mb-20">
          ...
          {/* Main Title */}
          <h1 className="text-[#004342] text-3xl md:text-4xl lg:text-5xl font-playfair mb-8 tracking-tight leading-tight compliance-heading">
            Our Certifications,{" "}
            <span className="compliance-heading-italic">
              Standards
            </span>
            , and
          ...
          <p className="text-[14px] text-gray-800 leading-relaxed max-w-4xl mx-auto">
            <strong>Century Papers</strong> Maintains Compliance With The
            Certifications And Standards That Matter To Our Buyers. This Page
            Details The Standards We Hold, The Documentation We Can Provide,
            And How To Request Verification.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 mb-24">
          ...
          <div className="flex flex-col lg:pr-4">
            ...
            <div className="flex flex-col gap-6 text-[13px] text-gray-800 leading-relaxed">
              <p>
                For all components of our product range that fall within the
                scope of Forest Stewardship Council (FSC) certification
                including MDF boards used in lampshades and laser-engraved
                journal covers we source only FSC-certified material and
                maintain full chain-of-custody documentation.
              </p>

              <p>
                Our FSC certification is independently audited on an annual
                basis. Certification documentation is available to all buyers
                on request. We do not make FSC claims on products that fall
                outside the scope of our certificate.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:pl-12 lg:border-l border-gray-300">
            ...
            <div className="flex flex-col gap-6 text-[13px] text-gray-800 leading-relaxed">
              ...
              <div>
                <p className="mb-2">
                  All international shipments are accompanied by complete and
                  accurate export documentation, including:
                </p>
                ...
                <ul className="flex flex-col gap-1.5">
                  ...
                  <li className="flex items-start">
                    <span className="mr-2 text-gray-500">→</span>
                    <span>
                      Certificate of Origin (as required by destination country)
                    </span>
                  </li>
                  ...
                  <li className="flex items-start">
                    <span className="mr-2 text-gray-500">→</span>
                    <span>
                      Phytosanitary Certificate (for seed-paper shipments, as
                      required)
                    </span>
                  </li>
                  ...
                  <li className="flex items-start">
                    <span className="mr-2 text-gray-500">→</span>
                    <span>
                      Any additional documentation required by specific import
                      markets on request
                    </span>
                  </li>
              ...
              <p>
                We have shipped to buyers across Europe, North America,
                Australasia, and Southeast Asia. We are familiar with
                documentation requirements for all major import markets. If
                your destination has specific requirements, contact us before
                placing an order.
              </p>
        ...
        <section className="border-t border-gray-300 pt-16 mt-16 mb-24">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 mb-20">
            ...
            <h2 className="text-[#004342] text-4xl md:text-5xl lg:text-5xl font-playfair tracking-tight md:w-1/2 compliance-heading">
              Product Safety &amp;{" "}
              <span className="compliance-heading-italic">
                Material
              </span>{" "}
            ...
            <p className="text-[14px] text-gray-800 leading-relaxed md:w-5/12 lg:w-1/3">
              Our paper products are made from post-consumer cotton fibre
              without chemical bleach or synthetic additives. The following
              material safety standards apply to our core product range:
            </p>
            ...
            {safetyStandards.map((item, index) => (
              <div
                ...
                className={`flex flex-col ${
                  index === 0
                    ? "lg:pr-8"
                    : index === safetyStandards.length - 1
                    ? "lg:pl-8"
                    : "lg:px-8"
                }`}
              >
            ...
            {additionalPolicies.map((policy, index) => (
              <div
                ...
                className={`flex flex-col ${
                  index === 0
                    ? "lg:pr-12"
                    : index === additionalPolicies.length - 1
                    ? "lg:pl-12"
                    : "lg:px-12"
                }`}
              >
        ...
        <style>{`
           ...
           * Material
           *
           * Same design as previous pages:
           * italic + thin weight
           */
          .compliance-heading-italic {
            font-family:
              "Playfair Display",
              Georgia,
              "Times New Roman",
