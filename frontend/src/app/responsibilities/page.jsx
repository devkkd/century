...
const environmentalData = [
  {
    ...
    // Grid order for desktop checkerboard pattern
    imgOrder: 'lg:order-1',
    txtOrder: 'lg:order-2'
  },
  {
    ...
    <main className="min-h-screen pt-12 px-6 lg:px-12 max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-col items-center text-center w-full max-w-5xl mx-auto mb-24">
        ...
        <h1 className="text-[#004342] text-3xl md:text-4xl lg:text-5xl font-playfair mb-8 tracking-tight leading-tight">
          We Are Responsible for <span className="italic font-medium">More</span> Than What <br className="hidden md:block" /> We Ship
        </h1>

        {/* Intro Paragraph */}
        <p className="text-[13px] md:text-sm text-gray-800 leading-relaxed max-w-4xl mx-auto">
          <strong>At Century Papers</strong>, Responsibility Is Not A Policy Document We Read Once A Year. It Is Built Into Every Stage Of Production In The Materials We Choose, The People We Employ, And The Way We Do Business.
        </p>
      </div>
      ...
      <section className="border-t border-gray-300 pt-10 mt-16">
        ...
        <h2 className="text-[#004342] text-4xl md:text-5xl lg:text-5xl font-playfair tracking-tight mb-16">
          The Planet <span className="italic">First</span> Always
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-12 lg:gap-y-16">
          {environmentalData.map((item) => (
            <React.Fragment key={item.id}>
              {/* Image Block */}
              <div className={`relative w-full aspect-square rounded-3xl overflow-hidden ${item.imgOrder}`}>
                <Image 
                  src={item.image} 
                  alt={item.title} 
                  fill
      ...
      <section className="border-t border-gray-300 pt-10 mt-24">
        ...
        <h2 className="text-[#004342] text-4xl md:text-5xl lg:text-5xl font-playfair tracking-tight mb-20">
          The People Who <span className="italic">Make</span> This Work
        </h2>
          ...
          {socialData.map((item) => (
            <div key={item.id} className="flex flex-col">
              ...
              <div className="relative w-20 h-20 mb-8">
                <Image src={item.icon} alt={item.title} fill className="object-contain object-left" />
              </div>
      ...
      <section className="border-t border-gray-300 pt-10 mt-24">
        ...
        <h2 className="text-[#004342] text-4xl md:text-5xl lg:text-5xl font-playfair tracking-tight mb-20">
          We Say What We Mean and Ship <span className="italic">What</span> We Promise
        </h2>
